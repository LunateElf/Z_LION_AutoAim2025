...
本仓库 fork 自 `dielivelr/Z_LION_AutoAim2025`，原项目采用 MIT License 开源。
原项目作者与版权声明见 `LICENSE` 文件。

本 fork 由 ZJUI Meta 队伍成员在 2025 赛季 RoboMaster 备赛/比赛过程中基于原项目进行修改，
主要用于 TensorRT 部署适配、脚本整理、相机标定/配置调整和队内调试。除特别说明外，
原项目主体设计、README 中的原始说明和鸣谢仍归原作者/原项目贡献者所有。
